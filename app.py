...
if menu == "Klasifikasi Diabetes":
    ...
    try:
        ...
        # Split Data untuk Visualisasi Metrik & Confusion Matrix
        ...
        with col1:
            st.subheader("📊 Evaluasi Metrik & Confusion Matrix")
            
            selected_eval_model = st.selectbox("Pilih Model untuk Dilihat Evaluasinya:", list(models_dict.keys()))
